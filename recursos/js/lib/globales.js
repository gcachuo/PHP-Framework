...
function ajax(fn, post, modulo) {
    ...
    return $.post(`index.php/ajax/${modulo || 0}/${fn}`,
        {
...
function cargarDropzone(idioma, modulo, nombre, folder) {
    try {
        Dropzone.autoDiscover = false;
        var url = "index.php?file=true&modulo=" + modulo + "&nombre=" + nombre + (!!folder ? "&folder=" + folder : '');
        $(".dropzone").dropzone(
            {
